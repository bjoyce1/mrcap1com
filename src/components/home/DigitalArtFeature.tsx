...
const DigitalArtFeature = () => {
  return (
    <SectionShell
      ...
      description="First Houston rap artist to sell a Hip Hop NFT on the blockchain. Explore the complete digital art collection."
      align="center"
            ...
            <>
              <div className="relative aspect-square rounded-xl overflow-hidden ring-1 ring-border/10 mb-3">
                ...
                {item.href.startsWith("http") && (
                  <div className="absolute top-3 right-3 bg-primary text-primary-foreground text-[10px] font-bold px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                    Buy NFT
                  </div>
                )}
              </div>
