    ...
    <SectionShell
      ...
      title={
        <div className="flex items-end justify-between gap-4 w-full">
          ...
          <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-primary text-sm font-normal" asChild>
            <Link to="/press">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {latestPosts.map((post, i) => (
          ...
          >
            <Link
              to={post.url!}
              className="block group p-6 rounded-2xl border border-border/20 bg-card/30 hover:border-primary/30 hover:-translate-y-1 transition-all duration-300 h-full"
            >
