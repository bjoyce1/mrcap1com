...
const AboutSection = () => {
  ...
  return <section id="about" className="py-24 md:py-32 border-b border-white/5 relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <p className="text-lg text-foreground leading-relaxed font-light">Cornelius A. Pratt, professionally known as Mr. CAP, is a Houston-born rapper, writer, and creative technologist with deep roots and a member of the South Park Coalition (SPC). Raised in a musical family and performing since age eight, CAP's voice carries the weight of lived experience — from street lessons and spiritual reflections to entrepreneurship and innovation.<span className="text-primary font-medium">Mr. CAP</span>, 
            ...
            <p className="text-muted-foreground leading-relaxed font-light">Today, with The SPC's latest project "The Ties That Bind Us" and the lead single "Bet'n On Me", Mr. CAP stands at the intersection of music, media, and technology — bridging old school integrity with new school innovation while representing Houston, South Park Coalition, and independent creators worldwide.<span className="italic text-foreground">"The Ties That Bind Us"</span> and 
          ...
          <div className="space-y-4">
            {highlights.map((item, index) => <div key={index} className="bg-white/[0.02] rounded-xl border border-white/5 p-5 hover:border-primary/30 transition-colors group">
