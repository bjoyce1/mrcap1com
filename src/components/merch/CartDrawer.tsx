...
export const CartDrawer = () => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent 
        side="right" 
        className="w-full sm:max-w-md lg:max-w-lg h-dvh max-h-dvh flex flex-col bg-background border-l border-border/50 p-0"
      >
        {/* Header - Fixed */}
        ...
        {/* Footer - Fixed */}
        {items.length > 0 && (
          <div className="flex-shrink-0 space-y-4 p-4 sm:p-6 border-t border-border/50 bg-background">
