    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full bg-background border-border/50">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="font-mono uppercase tracking-wider">Cart</SheetTitle>
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 bg-secondary/30 rounded-lg border border-border/30">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-mono font-medium truncate text-sm">{item.product.node.title}</h4>
