...
export function NftMilestoneSection() {
  return (
    <section id="nft-milestone" className="py-16 border-b border-white/5 bg-[radial-gradient(circle_at_top,_#111827,_#020617)]">
              ...
              <div className="relative rounded-3xl border border-emerald-500/40 bg-black/70 p-4 shadow-[0_0_40px_rgba(16,185,129,0.25)]">
                ...
                <div className="grid grid-cols-2 gap-3 text-[11px] text-gray-300">
                  <div className="rounded-2xl bg-black/70 border border-white/10 px-3 py-2">
                    <p className="uppercase text-[10px] text-gray-400">Category</p>
                    <p className="font-semibold text-gray-100">Music · Hip Hop NFT</p>
                  </div>
                  <div className="rounded-2xl bg-black/70 border border-white/10 px-3 py-2">
                    <p className="uppercase text-[10px] text-gray-400">Blockchain</p>
                    <p className="font-semibold text-gray-100">Ethereum (via OpenSea)</p>
                  </div>
                </div>
