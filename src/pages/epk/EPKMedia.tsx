    ...
    <>
      ...
      >
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl font-display font-bold mb-6 text-center">Narrative Bio</h2>
        ...
        <section className="py-16 bg-card/20 border-y border-border/50">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl font-display font-bold mb-8 text-center">Speaking & Media Topics</h2>
              <div className="grid md:grid-cols-2 gap-4">
                {speakingTopics.map((topic, index) => (
                  <div
                    key={index}
                    className="bg-card/50 border border-border/50 rounded-xl p-6 flex items-center gap-4"
                  >
